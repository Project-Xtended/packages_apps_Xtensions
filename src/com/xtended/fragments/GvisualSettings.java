...
public class GvisualSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.x_settings_gvisual);
    ...
    private void setupNavbarSwitchPref() {
        ...
        if (XtendedUtils.isNavbarColor("com.gnonymous.gvisualmod.pgm_rose")){
            mnbSwitch.setValue("6");
        } else if (XtendedUtils.isNavbarColor("com.gnonymous.gvisualmod.pgm_blue")){
            mnbSwitch.setValue("5");
        } else if (XtendedUtils.isNavbarColor("com.gnonymous.gvisualmod.pgm_purp")){
            mnbSwitch.setValue("4");
        } else if (XtendedUtils.isNavbarColor("com.gnonymous.gvisualmod.pgm_oprd")){
            mnbSwitch.setValue("3");
        } else if (XtendedUtils.isNavbarColor("com.gnonymous.gvisualmod.pgm_orcd")){
    ...
    private void setupHeaderSwitchPref() {
        ...
        if (XtendedUtils.isThemeEnabled("com.android.theme.header.xlarge")){
            mhdSize.setValue("3");
        } else if (XtendedUtils.isThemeEnabled("com.android.theme.header.large")){
            mhdSize.setValue("2");
        }
        else{
            mhdSize.setValue("1");
