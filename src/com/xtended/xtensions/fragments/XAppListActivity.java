...
import com.xtended.xtensions.fragments.XAppChooserAdapter.AppItem;
...
public class XAppListActivity extends Activity {
    ...
    XAppListAdapter mPkgAdapter;
    ListView mListView;

    /* app dialog stuff */
    XAppChooserDialog dDialog;
    ...
    private void initAppList() {
        dDialog = new XAppChooserDialog(this) {
            @Override
    ...
    private void loadList() {
        ...
        mPkgAdapter = new XAppListAdapter(this, list) {
            @Override
    ...
    public void removeApp(String pkg) {
        ...
        for (XAppListAdapter.PackageItem item : mPkgAdapter.getList()) {
