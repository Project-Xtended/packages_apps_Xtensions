...
public abstract class XAppChooserDialog extends Dialog {

    final XAppChooserAdapter dAdapter;
    ...
    public XAppChooserDialog(Context context) {
        super(context);
        ...
        dAdapter = new XAppChooserAdapter(context) {
            @Override
        ...
        dListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> av, View v, int pos, long id) {
                XAppChooserAdapter.AppItem info = (XAppChooserAdapter.AppItem) av
