...
public class StatusBarBattery extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        boolean hideForcePercentage = batteryStyle == 6 || batteryStyle == 7 || batteryStyle == 9 ; /*text, hidden or square style*/
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        if (preference == mBatteryIconStyle) {
            ...
            boolean hideForcePercentage = value == 6 || value == 7 || value == 9 ;/*text, hidden or square style*/
            mBatteryPercentage.setEnabled(!hideForcePercentage);
            return true;
